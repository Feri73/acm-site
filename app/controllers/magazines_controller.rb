class MagazinesController < ApplicationController
  ...
  before_action :check_author , only: [:new, :edit,:create, :update, :destroy]
  # GET /magazines
  # GET /magazines.json
  def index
  ...
  private
    ...
    def magazine_params
      params.require(:magazine).permit(:volume, :title, :published_date, :content, :attachment, :avatar)
    end

    def check_author
      if @magazine
        authorize_action_for @magazine
      else
